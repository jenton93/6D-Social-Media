...
**Already used:** blog `202608-blog-01` + 4 cut-downs · blog `202609-blog-02`
+ director post `202609-lid-02` · director post `202609-lid-03` (needs two
more examples).

**Running total from one four-minute voice note:** 2 blog posts, 6 social
posts, website copy on 3 pages. Two ideas still unused below.

**Still unused, and worth their own pieces:**
...
> Crew bookers. The good, the bad and the ugly. It's something that's needed
> by lots of big companies, and to a point we could probably use them too. But
> the issue is they have no real on-ground knowledge of the crew. They don't
> know how they work together. They don't know what the hidden skill sets are.
>
...
>
> Then you've got other people who really don't know the kit, but if you give
...
> they just quietly work away, knocking off every little job that needs doing
> without any requirement from anybody else.
>
> What makes a great team is having those different roles in different places,
> which is something a crew booker can never really see. How do you quantify
> it? How do you decide these people work together well?
>
> When you get to the size where you've got a crew booker, it's really hard to
> quantify and control the quality of the team. What ends up happening is you
> say: well, that person did that event and can do X, Y and Z, therefore they
> can do that on this event. But the client's different. The needs are
> different. The ancillary parts of the event require a slightly different
> view and a slightly different way of working.
>
> Some clients want to be told every detail. Other clients just want to be
> told everything's in hand. Some clients like to see the workings going on
> and the head-scratching. Other clients don't want to think there was ever a
> problem.
>
...
>
> What we try to do is have a core team of people booked by the PM and hand
...
>
> On repeat events the key is to keep consistent crew, so that the things that
