...
Six steps. Same six every time, whether you're taking one department or all
of them.

---

## 1. Work out the objectives

What the event is actually for, and how you'll know it worked.

Sounds obvious. It's the step most often skipped, and it's the reason shows
end up with a set that photographs badly for an event whose whole point was
the photographs. `‹ASSUMED›`
...
⛔ *Is a site visit standard on every job, or only above a certain size? Only
promise what always happens.*
...
the screens are the people making what goes on them, the content arrives in
the right format, at the right time, and looks right in the actual room rather
than on a designer's monitor.

## 5. The event runs

Get-in, rehearse, show, strike.

The person who quoted it is the person running it, and the crew are the crew
you met beforehand.

## 6. Collate and edit the post-event content
