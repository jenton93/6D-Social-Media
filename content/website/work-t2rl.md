...
**Set & staging at the QEII Centre, 2022–2024. A year away. The whole event
in 2026.**
...
## We went through the spec anyway

A client moving venue has no written record of what they had. They know the
...
## This year we're delivering all of it

Not set and staging. The whole event.

⛔ *Numbers: crew on site (40), delegates, rooms, get-in hours, which of the
six departments.*

## Why we did it

No company is the right fit for every event, and no client is the right fit
for every company. When T2RL moved to a venue where we weren't going to be the
supplier, helping them buy it well was just what followed from that.

We'd have done it whether or not it came back to us. It happens to have come
back to us.

---

## ⚠️ What must not go in this case study

**The competency problems at the 2025 event.**
...
2. **It contradicts the principle the story is built on.** A case study whose
   moral is "no company is right for every event" cannot also say "and that
...
We did a client's set and staging for three years. Then they moved venue, and
the contract there meant they had to use the in-house supplier.
...
what they had. They know the event worked. They don't have the kit list, the
crew numbers or the timings that made it work. We did.
...
treat a relationship as longer than one job.
